...
4. Evaluate MLQDS and baseline methods on the test set. Current benchmark runs should keep `uniform`, Douglas-Peucker, and label Oracle in the matched results.
