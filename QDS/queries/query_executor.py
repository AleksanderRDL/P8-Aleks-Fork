...
def _dtw_like_distance(candidate: torch.Tensor, reference: torch.Tensor) -> float:
    """Compute a lightweight DTW-like distance for short snippets. See queries/README.md for details."""
...
def execute_similarity_query(
    ...
    """Execute a similarity query returning ranked trajectory indices. See queries/README.md for details."""
